...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v7/job/nextcloud/badge/icon) (`arm32v7/nextcloud` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v7/job/nextcloud/)
...
The arm32v7/nextcloud image supports auto configuration via environment variables. You can preconfigure everything that is asked on the install page on first run. To enable auto configuration, set your database connection via the following environment variables. ONLY use one database type!
