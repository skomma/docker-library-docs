...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/nextcloud/badge/icon) (`i386/nextcloud` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/nextcloud/)
...
The i386/nextcloud image supports auto configuration via environment variables. You can preconfigure everything that is asked on the install page on first run. To enable auto configuration, set your database connection via the following environment variables. ONLY use one database type!
