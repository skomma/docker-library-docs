...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/eclipse-mosquitto/badge/icon) (`i386/eclipse-mosquitto` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/eclipse-mosquitto/)
...
```console
$ docker run -it -p 1883:1883 -p 9001:9001 -v mosquitto.conf:/mosquitto/config/mosquitto.conf i386/eclipse-mosquitto
```
...
```console
$ docker run -it -p 1883:1883 -p 9001:9001 -v mosquitto.conf:/mosquitto/config/mosquitto.conf -v /mosquitto/data -v /mosquitto/log i386/eclipse-mosquitto
```
