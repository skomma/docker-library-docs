...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/eclipse-mosquitto/badge/icon) (`arm32v6/eclipse-mosquitto` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/eclipse-mosquitto/)
...
```console
$ docker run -it -p 1883:1883 -p 9001:9001 -v mosquitto.conf:/mosquitto/config/mosquitto.conf arm32v6/eclipse-mosquitto
```
...
```console
$ docker run -it -p 1883:1883 -p 9001:9001 -v mosquitto.conf:/mosquitto/config/mosquitto.conf -v /mosquitto/data -v /mosquitto/log arm32v6/eclipse-mosquitto
```
