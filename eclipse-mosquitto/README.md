...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/eclipse-mosquitto/badge/icon) (`ppc64le/eclipse-mosquitto` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/eclipse-mosquitto/)
