...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/ghost/badge/icon) (`arm32v6/ghost` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/ghost/)
...
```console
$ docker run -d --name some-ghost arm32v6/ghost
```
...
```console
$ docker run -d --name some-ghost -p 3001:2368 arm32v6/ghost
```
...
```console
$ docker run -d --name some-ghost -p 3001:2368 -v /path/to/ghost/blog:/var/lib/ghost/content arm32v6/ghost:1-alpine
```

### Ghost 0.11.xx

```console
$ docker run -d --name some-ghost -p 3001:2368 -v /path/to/ghost/blog:/var/lib/ghost arm32v6/ghost:0.11-alpine
```
...
```console
$ docker run -d --name some-ghost --volumes-from some-ghost-data arm32v6/ghost
```
...
```console
$ docker run -d --name some-ghost -e url=http://some-ghost.example.com arm32v6/ghost
```
