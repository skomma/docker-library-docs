...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/ghost/badge/icon) (`arm64v8/ghost` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/ghost/)
...
```console
$ docker run -d --name some-ghost -p 3001:2368 arm64v8/ghost
```
...
```console
$ docker run -d --name some-ghost -p 3001:2368 -v /path/to/ghost/blog:/var/lib/ghost/content arm64v8/ghost:1-alpine
```

### Ghost 0.11.xx

```console
$ docker run -d --name some-ghost -p 3001:2368 -v /path/to/ghost/blog:/var/lib/ghost arm64v8/ghost:0.11-alpine
```
...
```console
$ docker run -d --name some-ghost --volumes-from some-ghost-data arm64v8/ghost
```
...
```console
$ docker run -d --name some-ghost -e url=http://some-ghost.example.com arm64v8/ghost
```
