...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/ghost/badge/icon) (`amd64/ghost` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/ghost/)
...
```console
$ docker run -d --name some-ghost -p 3001:2368 amd64/ghost
```
